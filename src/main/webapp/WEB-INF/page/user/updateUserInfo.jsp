...
<body>
				...
				<div class="box col-md-12">
						<div class="box-inner">
							...
							<form id="updateUserForm" method="post">
								...
								<div class="form-group">
										<div class="group">
										<label class="col-lg-2 control-label">BU Name</label>
										<div class="col-lg-4">
											<select class="form-control" name="buName" id="buName" data-bv-group=".group">
										...
										<div class="col-lg-4">
											<select class="form-control" name="csSubDept" id="csSubDept" data-bv-group=".group">
												<option value="">--Option--</option>
											</select>
										</div>
										</div>
	...
	<script type="text/javascript" src="<%=path %>/js/pmo/updateUserInfo.js"></script>
	<script type="text/javascript" src="<%=path %>/js/pmo/userValid.js"></script>
