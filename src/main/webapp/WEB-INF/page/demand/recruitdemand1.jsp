								...
								<form id="recruitdemandForm" method="post">
									...
									<div class="form-group">
										...
										<div class="group">
											...
											<div class="col-lg-4">
												<select onchange="changeHsbcDept()" class="form-control" name="hsbcDept"
													data-bv-notempty
									...
									<div class="form-group">
										...
										<div class="group">
											<label class="col-sm-2 control-label">Req Published
												Date</label>
											<div class="col-md-4">
												<div class="input-group date form_datetimep col-sm-12"
													data-link-field="dt_set_order_time_input">
													<input class="form-control" type="text" readonly
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
				          <h5>If JobCode exist,Please set Requirement Number is 1</h5>
			            </div>
