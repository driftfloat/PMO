				...
				<div class="box col-md-12">
						<div class="box-inner">
							<div class="box-header well" data-original-title="">
								<h2>
									<i class="glyphicon glyphicon-user"></i> 入场员工注册
								</h2>
							</div>
							...
							<form id="registerEmployeeForm" method="post">
										...
										<div class="group">
											...
											<div class="col-sm-4">
												<input type="text" class="form-control" name="staffName"
													id="staffName"  value="${employee.staffName}"/>
											</div>
										</div>
								</div>
								<br/><br/>
								<div class="form-group">
										...
										<div class="col-lg-4">
											<select class="form-control" name="staffRegion" data-bv-notempty
												...
												<option value="${employee.staffRegion}">${employee.staffRegion}</option>
											</select>
										</div>
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-lg-4">
											<select class="form-control" name="staffLocation" data-bv-notempty  id="staffLocation" >
												<option value="${employee.staffLocation}">${employee.staffLocation}</option>
											</select>
										</div>
										</div>
										<div class="group">
									...
									<div class="group">
										...
										<div class="col-md-4">
											<div class="input-group date form_datetime col-sm-12"
												data-link-field="dt_set_order_time_input">
												<input class="form-control" type="text" disabled="disabled"
													id="graduationDate1" name="graduationDate1" value="${employee.graduationDate}"> <span
													class="input-group-addon"><span
													class="glyphicon glyphicon-th"></span></span> <input type="hidden"
								...
								<div class="form-group">
										...
										<div class="col-lg-4">
											<select class="form-control" name="role" data-bv-notempty id="role" >
										...
										<div class="col-lg-4">
											<select class="form-control" name="skill" data-bv-notempty id="skill" ">
												<option value="${employee.skill}">${employee.skill}</option>
											</select>
										</div>
										</div>
								</div>
										...
										<div class="group">
											...
											<div class="col-sm-4">
												<input type="text" class="form-control" name="billRate"
													id="billRate" value="${employee.billRate}"/>
											</div>
										</div>
								</div>
								<br/><br/>
