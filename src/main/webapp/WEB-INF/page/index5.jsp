<%@ page language="java"
	import="java.util.*,com.pmo.dashboard.entity.CandidateInfo,net.sf.json.JSONObject"
	pageEncoding="utf-8" contentType="text/html; charset=utf-8"%>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions"%>
<%
	String path = request.getContextPath();
	CandidateInfo candidateInfo =(CandidateInfo) request.getAttribute("candidateInfo");
	String cInfo = JSONObject.fromObject(candidateInfo).toString();
%>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
	...
	<script type="text/javascript" src="<%=path %>/js/pmo/employeeEntry.js"></script>
	<script type="text/javascript" src="<%=path %>/js/pmo/employeeValidForEntry.js"></script>
