...
<body>
	...
	<div class="ch-container">
				...
				<div class="box col-md-12">
						<div class="box-inner">
							...
							<div id="candidateInfo" class="box-content">
							    <form id="blackListForm" method="post" class="form-horizontal">
									<div class="group">
									...
									<table id="blackList" class="table table-striped table-bordered">
										<thead>
											<tr>
												<th>Name</th>
												<th>Sex</th>
		...
		<div class="modal fade" id="blackListStatusModal" tabindex="-1" role="dialog"
			aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="box-header well" data-original-title="">
					 ...
					 <form id="statusCandidateForm" method="post" class="form-horizontal">
						...
						<div class="group">
							...
							<div class="col-lg-4" style="width:60%;">
								<select class="form-control" id="blackListCandidateStatus" name="blackListCandidateStatus" data-bv-group=".group">
									<option value="">--Option--</option>
	...
	<script type="text/javascript" src="<%=path %>/js/pmo/blackList.js"></script>
