...
<body>
				...
				<div class="box col-md-12">
						<div class="box-inner">
							<div class="box-header well" data-original-title="">
								<h2>
									<i class="glyphicon glyphicon-user"></i> 面试官信息反馈
								</h2>
							</div>
							<form id="registerEmployeeForm" method="post">
								...
								<div class="form-group">
									<div style="text-align:center;">
										<textarea id = "interviewFeedBack" style="width:80%;height:100px"></textarea>
									</div>
	...
	<script type="text/javascript" src="<%=path %>/js/pmo/interviewFeedBack.js"></script>
